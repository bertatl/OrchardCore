...
namespace OrchardCore.ContentManagement
{
    public class DefaultContentManager : IContentManager
    {
        ...
        protected async Task<ContentItem> BuildNewVersionAsync(ContentItem existingContentItem)
        {
            ...
            buildingContentItem.Apply(existingContentItem);
        ...
        public async Task<ContentItem> CloneAsync(ContentItem contentItem)
        {
            ...
            {
                var clonedData = JObject.FromObject(contentItem.Data);
                foreach (var property in clonedData.Properties())
                {
                    context.CloneContentItem.Data[property.Name] = property.Value;
                }
            }
